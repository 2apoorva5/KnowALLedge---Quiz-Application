...
import com.application.knowalledge.Model.QuestionsModel;
...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    private void startTimer(int qno) {
        ...
        countDownTimer = new CountDownTimer(timeToAnswer * 1000, 20) {
            ...
            public void onFinish() {
                canAnswer = false;
                questionFeedback.setText("Time's up! Not Answered!");
    ...
    private void verifyAnswer(TextView selectedAnswerTextView) {
        if (canAnswer) {
            if (questionsToAnswer.get(currentQuestion - 1).getAnswer().equals(selectedAnswerTextView.getText())) {
                correctAnswers++;
                selectedAnswerTextView.setTextColor(getResources().getColor(android.R.color.black, null));
                selectedAnswerTextView.setBackground(getResources().getDrawable(R.drawable.correct_answer_bg, null));

                questionFeedback.setText("Correct Answer");
                questionFeedback.setTextColor(getResources().getColor(R.color.colorPrimary, null));
            } else {
                wrongAnswers++;
                selectedAnswerTextView.setTextColor(getResources().getColor(android.R.color.white, null));
                selectedAnswerTextView.setBackground(getResources().getDrawable(R.drawable.wrong_answer_bg, null));
    ...
    private void showNextBtn() {
        if (currentQuestion == totalQuestionsToAnswer) {
            nextQuestionText.setText("Submit Results");
        }
